...
function removeArtist(artists, i){
  let remArtist = [...artists]
    remArtist.splice(i, 1)
  return remArtist
}
...
console.log(addArtist(artists, 'Heidi Gunter', '1992 - 2023', 'Full Stack Web Development', 'American', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed egestas risus ac nibh pulvinar, sit amet feugiat lectus gravida. In nec lorem euismod, imperdiet quam ultrices, iaculis ex. Etiam quis tristique diam, eu sollicitudin diam.'))
